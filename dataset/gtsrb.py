...
def prepare_train_loaders(config):
    hf_train_split = load_dataset("tanganke/gtsrb", split="train", cache_dir=config.get('hf_cache_dir'))
    
    train_dataset = HFGtsrbDataset(
...
def prepare_test_loaders(config):
    hf_full_test_split = load_dataset("tanganke/gtsrb", split="test", cache_dir=config.get('hf_cache_dir'))
    ...
    final_classnames = load_dataset("tanganke/gtsrb", split="train").features['label'].names
